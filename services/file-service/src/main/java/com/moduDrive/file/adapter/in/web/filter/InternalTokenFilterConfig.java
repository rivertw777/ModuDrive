 ...
 * {@code /api/v1/**} routes are authenticated at the gateway and never carry this header. Lives
 * next to the filter rather than under {@code adapter/in/web/config} so both classes can stay
 * package-private. */
@Configuration
